class script(object):
    START_TXT = """ʜᴇʟʟᴏ {},
ᴍʏ ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>{}</a>, ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴀɴʏ 🍿 ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ, ᴊᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ ꜰʀᴇᴇ 🤩"""
...
# ⚠️ Please don't change our credits 𝚃𝙷𝙰𝙽𝙺𝚂 𝚃𝙾 & 𝙳𝙴𝚅 👇🏻
    ...
    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ: {}
✯ Cʀᴇᴀᴛᴏʀ: <a href=https://t.me/Om56577>OM-I</a></b>
✯ Lɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
✯ Dᴇᴠᴏʟᴏᴘᴇʀ: <a href='https://t.me/Om56577'>OM-I</a>
...
<b>NOTE:</b>
<b>𝟷. BECK 𝚂𝙷𝙾𝚄𝙻𝙳 𝙷𝙰𝚅𝙴 𝙰𝙳𝙼𝙸𝙽 𝙿𝚁𝙸𝚅𝙸𝙻𝙻𝙰𝙶𝙴.
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @Om56577"""
    JSON_TXT = """<b>JSON:</b>
...
🍿 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝘁𝗵𝗲 𝘄𝗼𝗿𝗹𝗱'𝘀 𝗰𝗼𝗼𝗹𝗲𝘀𝘁 𝘀𝗲𝗮𝗿𝗰𝗵 𝗲𝗻𝗴𝗶𝗻𝗲!

ꜱᴇᴀʀᴄʜ ꜰᴏʀ ᴀɴʏ ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ: 
</b>
"""
...
▫️<a href=https://t.me/CinematoBugTV>🔸ᴍᴀɪɴ
</a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Kolkata</code></b>"""
    ...
    ALRT_TXT = """ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ꜰᴏʀ ʏᴏᴜ ꜱɪʀ"""
    ...
    MVE_NT_FND = """<b>ᴛʜɪꜱ ᴍᴏᴠɪᴇ ɪꜱ ɴᴏᴛ ʏᴇᴛ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ᴀᴅᴅᴇᴅ ᴛᴏ ᴅᴀᴛᴀʙᴀꜱᴇ. ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏɴʟʏ ᴀᴛ ʀꜱ.10 - @Movies_Rs_10</b> """
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    I_CUDNT = """ʜᴇʟʟᴏ {} ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇꜱ ɪɴ ᴛʜᴀᴛ ɴᴀᴍᴇ. ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏɴʟʏ ᴀᴛ ʀꜱ.10 - @Movies_Rs_10
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ' : ( ! , . / )"""
    ...
    I_CUD_NT = """ʜᴇʟʟᴏ {} ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ.ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ. ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏɴʟʏ ᴀᴛ ʀꜱ.10 - @Movies_Rs_10"""
    
    CUDNT_FND = """ʜᴇʟʟᴏ {} ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ? ʏᴏᴜ ᴄᴀɴ ʙᴜʏ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏɴʟʏ ᴀᴛ ʀꜱ.10 - @Movies_Rs_10"""
